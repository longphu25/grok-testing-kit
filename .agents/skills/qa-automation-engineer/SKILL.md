...
- Generate regression suite → _(redirect sang `/generate-application-test-plan`or`/generate-manual-testcases-rbt`)_
- Generate test data
- Analyze flaky test
...
> When the user requests "full automation suite" or "bootstrap automation" → automatically select Mode FULL.
